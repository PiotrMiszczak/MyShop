...
function SummaryPage(props) {
  ...
  const { order, loading, succes, error } = useSelector(
  ...
  function handleOrder() {
    dispatch(
      createOrder({ ...cart, orderItems: cartItems, totalPrice, deliveryPrice })
    );
  }
      ...
      <div className="summary">
        <div className="summary__info">
          <div className="summary__shipping">
            <h2>Shipping</h2>
            <p>
              {shipping.adress},{shipping.country}
            </p>
          </div>
        ...
        <div className="summary__actions">
          ...
          <p>
            ...
            {deliveryPrice == 0
              ? "free"
              : deliveryPrice + "$(free for orders above 200$)"}
          </p>
          <span>Total: {totalPrice}$</span>
          <button onClick={handleOrder} className="summary__button">
            Place order
          </button>
        </div>
      </div>
